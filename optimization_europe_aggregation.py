...
from optimization_preparation import get_forest_swp, get_cpool, \
    ...
    get_forest_et, get_harvests_via_species_file
...
# 2010
iter_csv = pd.read_csv('/home/konni/Documents/konni/projekte/phd/data/simulation_inputs/other_inputs/global_forest_ST_1871-2011_CORRECTED_1y_mask_gridlist_europe_forexclim.txt',
...
iter_forest_csv = pd.read_csv(
    '/home/konni/Documents/konni/projekte/phd/data/simulation_inputs/other_inputs/global_nat_for_LC_1871-2011_CORRECTED_1y_mask_gridlist_europe_CORRECT.txt_capitalized',
    delim_whitespace=True, iterator=True)
...
def get_es_value(basepath, es_name, min_year=2100, max_year=2130, lons_lats_of_interest=None, rcp=None):
    ...
    if es_name == 'cpool':
        ...
        data = get_forest_swp(basepath, min_year, max_year, lons_lats_of_interest)
    elif es_name == 'et':
...
def aggregate_to_europe_given_fig(axs, portfolioss, used_simulations, subaxes_titles=True):
